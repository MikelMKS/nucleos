...
<form action = "{{route('insertaua')}}" method = "POST" enctype='multipart/form-data'>
{{csrf_field()}}
<table align="center"  class="FormS">
 		<tr>
 			<td align="middle" valign="middle" ><table align="middle">
 				...
 				<tr>
 					<td class="subtituloR" align="center">Nueva Ubicacion de Almacen<br>
					</td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
				...
				<tr>
 				...
 				<tr>
					...
					<tr>
 					<td align="center" class="subtituloD">Datos de Ubicacion</td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
 					</tr>
					...
					<i class="glyphicon glyphicon-home"></i>
 						<input type="text" name="ubi" size="20" maxlength="30" placeholder="Ubicacion del Almacen" required="required" value="{{old('ubi')}}" class="estTF" /></td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
 					</tr>
					...
					<i class="glyphicon glyphicon-list-alt"></i>
 						<input type="text" name="est" size="20" maxlength="50" placeholder="Estado"  required="required"  value="{{old('est')}}"/></td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
 					</tr>
					...
					<i class="glyphicon glyphicon-text-background"></i>
 						Selecciona el Area de Produccion<select required class="combob" name = 'idap'>
			...
			@endforeach
					...
					<tr><td align="center"><input type="submit" value="Crear Ubicacion de Almacen" class="btn btn-success" ></td>
 					</tr><tr>
 					<td>&nbsp;</td>
 					</tr><tr>
 					<td>&nbsp;</td>
