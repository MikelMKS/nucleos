...
<form action = "{{route('insertaadep')}}" method = "POST" enctype='multipart/form-data'>
{{csrf_field()}}
<table align="center"  class="FormS">
 		<tr>
 			<td align="middle" valign="middle" ><table align="middle">
 				...
 				<tr>
 					<td class="subtituloR" align="center">Nueva Area de Produccion<br>
					</td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
				...
				<tr>
 				...
 				<tr>
					...
					<tr>
 					<td align="center" class="subtituloD">Datos de Area</td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
 					</tr>
					...
					<i class="glyphicon glyphicon-text-background"></i>
 						<input type="text" name="nom" size="20" maxlength="100" placeholder="Nombre del Area" required="required" value="{{old('nom_area')}}" class="estTF" /></td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
 					</tr>
					...
					<i class="glyphicon glyphicon-pencil"></i>
 						<textarea name="desc" size="20" maxlength="500" placeholder="Descripcion"  required="required"  value="{{old('desc')}}"></textarea></td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
 					</tr>
					...
					<i class="glyphicon glyphicon-user"></i>
 						Selecciona el Usuario Encargado<select class="combob" required name = 'idu'>
	    
			@foreach($usuarios as $usua)
			<option value = '{{$usua->id_usuario}}'>{{$usua->usuario}}</option>
			@endforeach
                  </select>
 					</tr>
					<tr>
					...
					<tr><td align="center"><input type="submit" value="Crear Area de Produccion" class="btn btn-success" ></td>
 					</tr><tr>
 					<td>&nbsp;</td>
 					</tr><tr>
 					<td>&nbsp;</td>
