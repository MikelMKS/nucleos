...
<form action = "{{route('insertatdn')}}" method = "POST" enctype='multipart/form-data'>
{{csrf_field()}}
<table align="center"  class="FormS">
 		<tr>
 			<td align="middle" valign="middle" ><table align="middle">
 				...
 				<tr>
 					<td class="subtituloR" align="center">Nuevo Tipo de Nucleo<br>
					</td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
				...
				<tr>
 				...
 				<tr>
					...
					<tr>
 					<td align="center" class="subtituloD">Datos del tipo de nucleo</td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
 					</tr>
					...
					<i class="glyphicon glyphicon-asterisk"></i>
 						<input type="text" name="tnu" size="20" maxlength="30" placeholder="Tipo de Nucleo" required="required" value="{{old('tnu')}}" class="estTF" /></td>
 					</tr>
					<tr>
 					<td>&nbsp;</td>
 					</tr>
